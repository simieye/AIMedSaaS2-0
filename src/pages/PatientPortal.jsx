...
export default function PatientPortal(props) {
  ...
  const handleTabChange = value => {
    ...
    toast({
      title: "页面切换",
      description: `已切换到${value === 'dashboard' ? '健康概览' : value === 'records' ? '医疗记录' : value === 'appointments' ? '预约管理' : value === 'prescriptions' ? '处方管理' : '健康数据'}页面`
    });
  };
        ...
        <div className="max-w-7xl mx-auto p-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">个人健康管理与医疗服务平台</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <SearchBar onSearch={handleSearch} placeholder="搜索医疗记录、预约..." />
          ...
          <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
            <TabsList className="grid w-full grid-cols-5 bg-white p-1 rounded-lg shadow">
              ...
              <TabsTrigger value="health-data" className="flex items-center space-x-2">
            ...
            <TabsContent value="dashboard" className="space-y-6">
              {isLoading ? <LoadingOverlay /> : <Card>
                  <CardHeader>
                    <CardTitle>健康概览</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <EmptyState icon={Heart} title="健康概览" description="健康数据概览功能正在开发中..." />
                  </CardContent>
                </Card>}
            </TabsContent>
            ...
            <TabsContent value="records" className="space-y-6">
              {isLoading ? <LoadingOverlay /> : <Card>
                  ...
                  <CardContent>
                    <EmptyState icon={FileText} title="医疗记录" description="医疗记录管理功能正在开发中..." />
                  </CardContent>
                </Card>}
            </TabsContent>
            ...
            <TabsContent value="appointments" className="space-y-6">
              {isLoading ? <LoadingOverlay /> : <Card>
                  ...
                  <CardContent>
                    <EmptyState icon={Calendar} title="预约管理" description="预约管理功能正在开发中..." />
                  </CardContent>
                </Card>}
            </TabsContent>
            ...
            <TabsContent value="prescriptions" className="space-y-6">
              {isLoading ? <LoadingOverlay /> : <Card>
                  ...
                  <CardContent>
                    <EmptyState icon={Pill} title="处方管理" description="处方管理功能正在开发中..." />
                  </CardContent>
                </Card>}
            </TabsContent>
            ...
            <TabsContent value="health-data" className="space-y-6">
              {isLoading ? <LoadingOverlay /> : <Card>
                  ...
                  <CardContent>
                    <EmptyState icon={Activity} title="健康数据" description="健康数据管理功能正在开发中..." />
                  </CardContent>
                </Card>}
            </TabsContent>
          </Tabs>
