...
import { PartnerTranslationProvider } from '@/components/PartnerTranslationProvider';
...
export default function PartnerPortal(props) {
  ...
  const handleTabChange = value => {
    ...
    toast({
      title: "页面切换",
      description: `已切换到${value === 'dashboard' ? '仪表板' : value === 'api-keys' ? 'API密钥' : value === 'agreements' ? '协议管理' : value === 'billing' ? '账单管理' : value === 'docs' ? '文档中心' : value === 'tickets' ? '工单支持' : '设置'}页面`
    });
  };
            ...
            <div className="max-w-7xl mx-auto p-4">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4">
                    <SearchBar onSearch={handleSearch} placeholder="搜索API密钥、协议或账单..." />
