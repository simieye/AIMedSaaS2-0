...
export default function ApiKeyManagementPage(props) {
  const {
    $w,
    style
  } = props;
  ...
  const [notifications, setNotifications] = React.useState([{
    ...
    id: 2,
    title: '密钥过期提醒',
    message: '有3个API密钥将在7天内过期',
    time: '1小时前',
    read: false
  }, {
    id: 3,
    title: '使用量异常',
    message: '检测到API使用量异常增长',
    time: '2小时前',
    read: true
  }]);
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">API密钥创建、管理与安全监控</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <SearchBar onSearch={handleSearch} placeholder="搜索API密钥、合作伙伴..." />
