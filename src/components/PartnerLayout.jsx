...
// @ts-ignore;
import { Building2, Key, FileText, CreditCard, BookOpen, MessageSquare, Settings, LogOut, Globe } from 'lucide-react';

import { usePartnerTranslation } from '@/components/PartnerTranslationProvider';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-blue-600">PartnerPortal</h1>
            </div>
